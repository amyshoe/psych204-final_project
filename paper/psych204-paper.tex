...
After giving students exams with both single-reference and double-reference algebra problems, they were able to replicate their results from \citeA{KoedNath2004}, for single-reference problems and found opposite performance rates for double-reference problems. As it turns out, the double-reference problems Nathan and Koedinger tested are more likely to be resolved correctly in their symbolic form than in their story form, which thus identifies a potential threshold for the increase in difficulty of story problems. 
